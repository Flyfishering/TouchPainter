...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    coordinatingController.canvasViewController = [[FLY_CanvasViewController alloc] init];
    coordinatingController.activeViewController = coordinatingController.canvasViewController;
    
    TestObject *obj = [TestObject shareInstance];
    obj.canvasViewController = [[FLY_CanvasViewController alloc] init];
...
//    self.window.rootViewController = obj.canvasViewController;
